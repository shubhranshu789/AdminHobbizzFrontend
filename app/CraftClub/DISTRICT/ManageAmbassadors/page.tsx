...
export default function MemberRequests() {
  ...
  useEffect(() => {
    ...
    const fetchMemberRequests = async () => {
      ...
      try {
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/craftclub/ambassador-requests?district=${userDistrict}`, {
        //const response = await fetch(`http://localhost:5000/craftclub/ambassador-requests?district=${userDistrict}`, {
          method: "GET",
          headers: {
  ...
  const handleApprove = async (userId: string) => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/craftclub/approve-ambassador/?district=${userDistrict}&userid=${userId}`, {
      //const response = await fetch(`http://localhost:5000/craftclub/approve-ambassador/?district=${userDistrict}&userid=${userId}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          "Authorization": "Bearer " + localStorage.getItem("jwt"),
  ...
  const handleDisapprove = async (userId: string) => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/craftclub/disapprove-ambassador/?district=${userDistrict}&userid=${userId}`, {
      //const response = await fetch(`http://localhost:5000/craftclub/disapprove-ambassador/?district=${userDistrict}&userid=${userId}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          "Authorization": "Bearer " + localStorage.getItem("jwt")
