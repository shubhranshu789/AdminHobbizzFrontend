...
const activities = [
  {
    ...
    location: "Photography Lab 1A",
    image: "/placeholder.svg?height=200&width=300",
    description: "Learn the fundamentals of camera settings, lighting, and composition. Ideal for beginners.",
  },
  {
    id: 2,
    ...
    image: "/placeholder.svg?height=200&width=300",
    description: "Practice portrait photography with live models and natural lighting. Bring your camera.",
  },
  {
    id: 3,
    title: "Exhibition Curation & Setup",
    date: "June 22, 2025",
    time: "2:00 PM - 7:00 PM",
    location: "Photography Exhibition Hall",
    image: "/placeholder.svg?height=200&width=300",
    description: "Join us to organize and set up our end-of-semester photography exhibition. All members welcome!",
  },
]
...
export default function ArtClubPage() {
  ...
  useEffect(() => {
    ...
    const checkRequestStatus = () => {
      const requested = localStorage.getItem('photoClubRequested');
  ...
  useEffect(() => {
    const checkRequestStatus = async () => {
      setTimeout(() => {
        setHasRequested(localStorage.getItem("photoClubRequested") === "false")
      }, 500)
    }
  ...
  try {
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/photoclub/status`, {
      headers: {
  ...
  const handleJoinRequest = async () => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/photoclub/requestjoin?district=${encodeURIComponent(district)}`, {
        method: "PUT",
        headers: {
      ...
      setHasRequested(true)
      localStorage.setItem("craftClubRequested", "true")
    } catch (error) {
  ...
  const handleJoinRequestAmbassador = async () => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/photoclub/requestjoinforambassador?district=${encodeURIComponent(district)}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          "Authorization": "Bearer " + localStorage.getItem("jwt")
      ...
      setHasRequested(true)
      localStorage.setItem("photoClubRequested", "true")
  ...
  const handleWithdrawRequest = async () => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/photoclub/withdrawjoin`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          "Authorization": "Bearer " + localStorage.getItem("jwt")
      ...
      localStorage.setItem("craftClubRequested", "false")
    } catch (error) {
        ...
        <div style={{ padding: "20px", marginTop: "60px" }} className="container py-6">
          ...
          <div className="relative mb-8 overflow-hidden rounded-xl">
            ...
            <div className="absolute bottom-0 left-0 p-6">
              ...
              <h1 className="mt-2 text-3xl font-bold text-white">Photography Club</h1>
              ...
              <Tabs defaultValue="about" className="w-full" onValueChange={setActiveTab}>
                ...
                <TabsContent value="about" className="mt-6">
                  <div className="rounded-lg bg-white p-6 shadow-sm">
                    <h2 className="text-xl font-bold">About Photography Club</h2>
                    <p className="mt-4 text-gray-700">
                    The Photography Club is a vibrant community of creative individuals who share a passion for capturing moments through the lens. We welcome photographers of all skill levels, from beginners to experienced professionals. Our club provides a supportive environment where members can explore various photography styles, develop their technical and artistic skills, and showcase their work.
                    </p>
                    ...
                    <ul className="mt-3 grid gap-3 sm:grid-cols-2">
                      ...
                      >
                        ...
                        <span>Photo supplies provided</span>
                      </motion.li>
                      <motion.li
                        className="flex items-center gap-2 rounded-md border bg-white p-3 shadow-sm"
                        whileHover={{ y: -5, transition: { duration: 0.2 } }}
                    ...
                    <div className="mt-3 rounded-md border bg-gray-50 p-4">
                      ...
                      <div className="mt-2 flex items-center gap-2">
                        ...
                        <span>Photo Studio, Building B, Room 305</span>
                      </div>
                    </div>
                  </div>
                </TabsContent>
            ...
            <div>
              <Card>
                <CardContent className="p-6">
                  <h3 className="text-lg font-semibold">Join Photography Club</h3>
                  ...
                  <div className="mt-6 border-t pt-4">
                    ...
                    <div className="mt-3 grid gap-2 text-sm">
                      ...
                      <div className="flex items-center gap-2">
                        <MapPin className="h-4 w-4 text-gray-500" />
                        <span>Photo Building, Room 305</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 border-t pt-4">
                    ...
                    <p className="mt-2 text-sm">
                      ...
                      <a href="mailto:artclub@university.edu" className="text-blue-600 hover:underline">
                        photographyclub@university.edu
                      </a>
                    </p>
                  </div>
                </CardContent>
