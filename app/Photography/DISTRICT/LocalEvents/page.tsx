...
const LocalChapterPage: React.FC = () => {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/delete-event/?eventId=${eventToDeleteId}&club=${"photoclub"}`, {
        method: "DELETE",
      })
  ...
  const toggleStatus = useCallback(
    async (eventId: string) => {
      ...
      try {
        ...
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/update-chapter-status/${eventId}`, {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
          },
