...
export default function MemberRequests() {
  ...
  useEffect(() => {
    ...
    const fetchMemberRequests = async () => {
      ...
      try {
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/photoclub/ambassador-requests?district=${userDistrict}`, {
          method: "GET",
          headers: {
  ...
  const handleApprove = async (userId: string) => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/photoclub/approve-ambassador/?district=${userDistrict}&userid=${userId}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          "Authorization": "Bearer " + localStorage.getItem("jwt"),
  ...
  const handleDisapprove = async (userId: string) => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/photoclub/disapprove-ambassador/?district=${userDistrict}&userid=${userId}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          "Authorization": "Bearer " + localStorage.getItem("jwt")
