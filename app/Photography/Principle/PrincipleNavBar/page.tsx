...
// import "../../../Components/DISTRICT/ManageRoles/CreateEditor"
...
function page() {
  ...
  const gotoAddActivity = () => {
    router.push('/Photography/DISTRICT/AddActivities/AllActivities');
  }
  ...
  const manageDistrict = () => {
    router.push('/Photography/DISTRICT/Districts');
  }
  const manageRoles = () => {
    router.push('/Photography/DISTRICT/ManageRoles');
  }
  const AddEditor = () => {
    router.push('/Photography/DISTRICT/ManageRoles/CreateEditor');
  }
//   const gotoabout = () => {
...
//   }
  ...
  const gotoCreateCompitition = () => {
    router.push('/Photography/Principle/CreateCompitition');
  }

    const gotoViewCompitition = () => {
    router.push('/Photography/Principle/ViewCompitions');
  }
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-1">
              {[
                { name: "Create Compitition", icon: Home , id : "Home"},
                { name: "View Compitition", icon: Settings , id : "Add" },
                { name: "Add Editor", icon: Settings , id : "AddEditor" },
