...
function ParticularCompitionInner() {
  ...
  useEffect(() => {
    const fetchJudges = async () => {
      try {
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/photoallJudges`); // adjust if needed
    ...
    const fetchAssignedJudges = async () => {
      try {
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/photocompetition/${id}/judges`);
        const data = await res.json();
        setAssignedJudges(data.judges);
      } catch (err) {
  ...
  useEffect(() => {
    const fetchCompetition = async () => {
      try {
        ...
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/photogetCompitition/${id}`)
  ...
  const toggleLive = async (value: any) => {
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/photoactivity/set-live/${id}`, {
      method: "PUT",
  ...
  const handleAssignJudge = async (judgeId: any) => {
    ...
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/photoassignJudge`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  const handleRemoveJudge = async (judgeId: any) => {
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/photoremoveJudge`, {
        method: "POST",
        headers: {
  ...
  const generateResults = async (id: any) => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/${id}/photoresults`)
    ...
    setError(null);
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/${id}/photogenerate-result`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
