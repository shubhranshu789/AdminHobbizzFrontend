...
export default function CompetitionsPage() {
  ...
  const fetchCompetitions = async () => {
    try {
      setLoading(true)
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/photoallCompitition`, {
        headers: {
                    ...
                    <div className="flex gap-2" style={{ flexDirection: "column" }}>
                      ...
                      <Button
                        onClick={async () => {
                          ...
                          try {
                            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/photocompetition/${competition._id}`, {
                              method: "DELETE",
                            });
