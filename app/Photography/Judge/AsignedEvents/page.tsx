...
export default function AssignedEventsPage() {
    ...
    useEffect(() => {
        ...
        const fetchEvents = async () => {
            try {
                const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/photocompetitions/judge/${judgeId}`);
    ...
    const gotoParticularEvent = (id: any) => {
        router.push(`/Photography/Judge/AsignedEvents/ParticularEvent?id=${id}`);
    };
