...
export default function ArtClubHomepage() {
  ...
  const goToHeritage = () => {
    router.push("/Photography/Views/Heritage");
  };
  const goToGallery = () => {
    router.push("/Photography/Views/Gallery");
  };
  const goToAffair = () => {
    router.push("/Photography/Views/Affairs");
  };
  const goToCopition = () => {
    router.push("/Photography/Views/Contest");
  };
  const goToHallofFame = () => {
    router.push("/Photography/Views/HallOfFame");
  };
  ...
  const events = [
    ...
    {
      id: 3,
      title: "Portrait Drawing Contest",
      date: "2024-01-28",
      time: "3:00 PM",
      type: "Contest",
    },
  ...
  const cabinetMembers = [
    {
      name: "Dr. Maya Patel",
      role: "Director",
      image: "/avatars/1.JPG?height=200&width=200",
    },
    {
      name: "Prof. James Wilson",
      role: "Advisor",
      image: "/avatars/2.JPG?height=200&width=200",
    },
    {
      name: "Sophia Rodriguez",
      role: "Editor",
      image: "/avatars/3.JPG?height=200&width=200",
    },
  ];
  ...
  const artForms = [
    {
      name: "Madhubani",
      description:
        "Traditional folk art from Bihar, known for intricate patterns and vibrant colors.",
      image: "/images/Madhubani.jpeg?height=200&width=300",
    },
    {
      name: "Warli",
      description:
        "Ancient tribal art form using simple geometric shapes to depict daily life.",
      image: "/images/warli.JPG?height=200&width=300",
    },
    {
      name: "Tanjore",
      description:
        "Classical South Indian painting style with rich colors and gold foil.",
  ...
  return (
    ...
    >
      ...
      <div
        className={`fixed inset-0 bg-white z-[100] flex items-center justify-center transition-all duration-1000 ${
      ...
      {/* Hero Section */}
      <section
        className={`relative py-32 px-4 sm:px-6 lg:px-8 bg-white transition-all duration-1000 delay-300 ${
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <h1 className="text-5xl lg:text-6xl font-bold leading-tight">
                  ...
                  <br />
                  <span className="text-black">Shoot Your Story.</span>
                </h1>
                <p
                  className="text-xl text-gray-700 leading-relaxed"
                  style={{ userSelect: "text" }}
                >
               Join a vibrant community of young photographers where creativity knows no bounds. Express yourself through lenses, light, and unique perspectives.
                </p>
              </div>
      ...
      <section
        className={`py-16 px-4 sm:px-6 lg:px-8 bg-blue-600 text-white hover:bg-blue-700 transition-all duration-1000 ${
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            ...
            <div className="space-y-2 hover:scale-105 transition-transform duration-300 cursor-pointer p-4 rounded-lg hover:bg-blue-500/30 border-2 border-transparent hover:border-blue-300">
              ...
              <div className="text-blue-100">Photoworks Created</div>
            </div>
            <div className="space-y-2 hover:scale-105 transition-transform duration-300 cursor-pointer p-4 rounded-lg hover:bg-blue-500/30 border-2 border-transparent hover:border-blue-300">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">
              <span className="text-blue-600">About Our Photography Club</span>
            </h2>
            <p
              className="text-xl text-gray-700 max-w-3xl mx-auto"
              style={{ userSelect: "text" }}
            >
           We empower students to capture moments, tell stories, and unleash their creativity through the art of photography.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            >
              ...
              <CardContent>
                <p className="text-gray-700" style={{ userSelect: "text" }}>
                  Master the fundamentals with painting, sketching, and
            ...
            >
              ...
              <CardContent>
                <p className="text-gray-700" style={{ userSelect: "text" }}>
                  Explore modern digital tools and create stunning digital
                  masterpieces.
                </p>
              </CardContent>
            </Card>
            ...
            >
              ...
              <CardContent>
                <p className="text-gray-700" style={{ userSelect: "text" }}>
                  Connect with fellow Photography and grow together in a
      ...
      <section
        className={`py-20 px-4 sm:px-6 lg:px-8 bg-white transition-all duration-1000 ${
          visibleSections.has("cabinet-section")
            ? "translate-y-0 opacity-100"
            : "translate-y-10 opacity-0"
        }`}
        data-animate
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-700" style={{ userSelect: "text" }}>
              Dedicated mentors guiding your Photography journey
            </p>
          </div>
      ...
      <section
        className={`py-20 px-4 sm:px-6 lg:px-8 bg-gray-50 transition-all duration-1000 ${
          visibleSections.has("heritage-section")
            ? "translate-y-0 opacity-100"
            : "translate-y-10 opacity-0"
        }`}
        data-animate
          ...
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">
              <span className="text-blue-600">
                Photography Forms & Heritage
              </span>
            </h2>
            <p className="text-xl text-gray-700" style={{ userSelect: "text" }}>
              Celebrating traditional Indian Photography forms
            </p>
          </div>
      ...
      <section
        className={`py-20 px-4 sm:px-6 lg:px-8 bg-white transition-all duration-1000 ${
          visibleSections.has("contests-section")
            ? "translate-y-0 opacity-100"
            : "translate-y-10 opacity-0"
        }`}
        data-animate
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <CardContent>
                <p
                  ...
                  style={{ userSelect: "text" }}
                >
                  Theme: "Nature's Beauty" - Create Photowork inspired by nature
                </p>
                <div className="flex items-center justify-between">
            ...
            >
              <CardHeader>
                ...
                <CardTitle className="text-black">Photo of the Week</CardTitle>
              </CardHeader>
              <CardContent>
                <p
                  className="text-gray-700 mb-4"
            ...
            <Card className="bg-white hover:shadow-xl hover:shadow-blue-200/50 transition-all duration-300 transform hover:scale-105 hover:-translate-y-2 border-2 border-transparent hover:border-blue-400 hover:bg-blue-50/30">
              ...
              <CardContent>
                <p
                  ...
                  style={{ userSelect: "text" }}
                >
                  Annual exhibition of best digital Photoworks
                </p>
                <div className="flex items-center justify-between">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-blue-200" style={{ userSelect: "text" }}>
                Empowering students to explore their creative potential through
                art and community.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <Link
                  ...
                  onClick={() =>
                    window.open("https://facebook.com/artclub", "_blank")
                  }
                >
                ...
                <Link
                  ...
                  className="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center hover:bg-blue-500 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-blue-300/50 border-2 border-transparent hover:border-blue-300"
                  onClick={() =>
                    window.open("https://instagram.com/artclub", "_blank")
                  }
                >
                ...
                <Link
                  ...
                  className="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center hover:bg-blue-500 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-blue-300/50 border-2 border-transparent hover:border-blue-300"
                  onClick={() =>
                    window.open("https://twitter.com/artclub", "_blank")
                  }
                >
          ...
          <div className="border-t border-blue-800 mt-12 pt-8 text-center text-blue-200">
            <p style={{ userSelect: "text" }}>
              &copy; 2024 EduBiz Network. All rights reserved. | Photography
              Club - HOBBIZZ Platform
            </p>
          </div>
        </div>
      </footer>
