...
const Gallery = () => {
    ...
    const fetchImages = async () => {
        try {
            const res = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/photoviewgallerypost`);
            setImages(res.data || []);
        } catch (err) {
    ...
    const addImage = async (e: { preventDefault: () => void }) => {
        ...
        try {
            const res = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/photogallerypost`, {
                title,
    ...
    const handleDelete = async (id: any) => {
        ...
        try {
            ...
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/photoclub-gallery/${id}`, {
                method: "DELETE",
                headers: {
