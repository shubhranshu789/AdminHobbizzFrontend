...
const HallOfFameForm = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/photoheritage`, {
                method: "POST",
    ...
    const fetchItems = async () => {
        setLoading(true);
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/photoheritagegetallpost`);
            const data = await res.json();
    ...
    try {
      ...
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/photoclub-heritage/${id}`, {
        method: "DELETE",
        headers: {
