...
const ClubNewsForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/photoclubjournal`, {
        method: "POST",
  ...
  const fetchNews = async () => {
    setLoading(true);
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/photoclubjpurnalviewallpost`);
      const data = await res.json();
  ...
  const handleDelete = async (id: any) => {
    ...
    try {
      ...
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/photoclub-journal/${id}`, {
        method: "DELETE",
        headers: {
