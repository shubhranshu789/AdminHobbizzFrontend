...
function UpdateJournalinner() {
  ...
  useEffect(() => {
    const fetchJournal = async () => {
      ...
      try {
        ...
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/photoJournal/${journalId}`)
        if (!response.ok) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/photoclub-journal-update/${journalId}`, {
        method: "PUT",
        headers: {
