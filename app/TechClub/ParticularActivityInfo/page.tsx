...
function ParticularActivityInfoInner() {
  ...
  useEffect(() => {
    ...
    const fetchEvent = async () => {
      try {
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/techgetactivity/${id}`, {
          headers: {
  ...
  useEffect(() => {
    const fetchUploadStatus = async () => {
      ...
      try {
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/techhas-uploaded-user/${id}`, {
          headers: {
  ...
  useEffect(() => {
    const fetchParticipants = async () => {
      try {
        const token = localStorage.getItem("jwt");
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/techevent-participants-user/${id}`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
  ...
  const registerForActivity = async (activityId: string) => {
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/techregister-activity-user/${activityId}`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  const unregisterFromActivity = async (activityId: string) => {
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/techunregister-activity-user/${activityId}`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const post = async () => {
    ...
    try {
      ...
      if (result.url) {
        const token = localStorage.getItem("jwt");
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/techupload-photo-user/${id}`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const handleApproval = async (activityId: any, uploadId: any, isApproved: boolean) => {
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/techactivity/${isApproved ? "approve" : "disapprove"}-upload/${activityId}/${uploadId}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleApprovalHallOfFame = async (activityId: any, uploadId: any, isHallofFame: boolean) => {
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/techactivity/${isHallofFame ? "approve" : "disapprove"}-halloffame/${activityId}/${uploadId}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  useEffect(() => {
    const fetchHallOfFame = async () => {
      try {
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/techactivity/hallOfFamePosts/${event?._id}`);
        const data = await res.json();
