...
function ParticularCompitionInner() {
  ...
  useEffect(() => {
    const fetchJudges = async () => {
      try {
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/techallJudges`); // adjust if needed
    ...
    const fetchAssignedJudges = async () => {
      try {
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/techcompetition/${id}/judges`);
        const data = await res.json();
        setAssignedJudges(data.judges);
      } catch (err) {
  ...
  useEffect(() => {
    const fetchCompetition = async () => {
      try {
        ...
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/techgetCompitition/${id}`)
  ...
  const toggleLive = async (value: any) => {
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/techactivity/set-live/${id}`, {
      method: "PUT",
  ...
  const handleAssignJudge = async (judgeId: any) => {
    ...
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/techassignJudge`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  const handleRemoveJudge = async (judgeId: any) => {
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/techremoveJudge`, {
        method: "POST",
        headers: {
  ...
  const generateResults = async (id: any) => {
    ...
    setError(null);
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/${id}/techgenerate-result`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
